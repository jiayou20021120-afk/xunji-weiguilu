...
const GAME = { title:'循迹：未归录', sub:'历史悬疑解谜游戏', chip:'第一案 · 帛书' };
  ...
  steps: [
    ...
    { /* ② 点书架上露出来的那卷底稿 → 对白 A */
      ...
      dialogue:[
        ...
        { who:'蔡季襄', text:'这卷底稿，是我日夜对照帛书残片一点点写出来的。两千年前楚人的月令、创世记载，总得有人整理留存。' },
        { who:'蔡季襄', text:'眼下室内条件有限，很多模糊字迹看不清，普通纸笔描摹总会有偏差。我打算去上海，寻专业红外摄影设备，完整记录、精细修缮这套帛书。' },
        { who:'os', text:'他耗费心血写成考证手稿，一心只想把帛书完整清晰地留存下来。' }
      ]
    },
    { /* ③ 点帛书残片 → 特写 → 长卷展开 → 对白 B */
      hotspot:'silk',
    ...
    { /* ④ 点桌上的信纸 → 信件徐徐展开 */
      ...
      reveal:'letter1',
      dialogue:[
        { who:'os', text:'原来他写信吩咐助手，是为去上海修缮、完整记录帛书，一片苦心全落在文物身上。' }
      ]
    },
    { /* ⑤ 手稿自动收拢入槽 → 情绪锚点 */
      auto:true,
    ...
    steps: [
      ...
      { /* ② 点相机底下压着的信 */
        ...
        dialogue:[
          ...
          { who:'os', text:'看来蔡先生也察觉到了此人不值得信任，所以留了后手，可对面根本不当回事。' }
        ],
...
const CHAP3 = (() => {
  ...
  const CHAP3 = {
    ...
    /* 这一章没有对白，落地就是一段旁白 */
    intro: [
      { who:'os', text:'我到的时候东西已经装箱了。' },
      { who:'os', text:'赶上的只是看它上船这一段。'}
    ],
    introTip: '这一夜，你只能看着',
...
const CHAP4 = (() => {
  ...
  const CHAP4 = {
    ...
    intro: [
      { who:'os', text:'东西早登记入库了，这会儿轮到给它们排去处。' },
    ...
    steps: [
      { /* ① 贴着缝隙偷听 */
        ...
        dialogue:[
          ...
          { who:'os', text:'在他们眼中，承载楚人千年历法创世记载的国宝，仅仅是可以拆分倒卖、换取利益的商品。' }
        ]
      },
      { /* ② 看那只木盒 */
        hotspot:'box',
        ...
        dialogue:[
          ...
          { who:'os', text:'出去的日子倒是空着，因为得等七十五年才填得上。' }
        ],
      ...
      { /* ⑤ 收物证 + 情绪锚点 */
        ...
        dialogue:[
          ...
          { who:'os', text:'我握紧手里的盒盖，指尖上是温润的触感。那份沉甸甸的期盼，跟着一块儿落进了心里。' }
        ]
      }
    ],
    ...
    steps: [
      ...
      { /* ③ 看新闻 */
        ...
        dialogue:[
          ...
          { who:'os', text:'从十六铺上船那晚算起，中间隔了七十八年零十个月。' }
        ]
      },
      { /* ④ 收物证 */
        auto:true,
...
const CHAP6 = (() => {
  ...
  const CHAP6 = {
    ...
    intro: [
      ...
      { who:'os', text:'我手上的东西比出发时多了不少。可这屋里该有的，还是缺一件。' }
    ],
    ...
    steps: [
      ...
      { /* ② 右边那卷 */
        ...
        dialogue:[
          ...
          { who:'os', text:'两卷中间空着一格，这可不是布展的人忘了摆。' }
        ]
      },
      { /* ③ 空着的那一格 */
        hotspot:'empty',
